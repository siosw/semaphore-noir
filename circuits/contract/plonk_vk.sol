...
contract TurboVerifier {
    ...
    **/
        ...
        returns (Types.VerificationKey memory)
    {
        ...
        assembly {
            mstore(add(vk, 0x00), 2048) // vk.circuit_size
            ...
            mstore(
                add(vk, 0x80),
                0x0fa9bb21bc73d07b3bb6dcd7fddabf54fd7efed80adc442020a3a65d579d71ae
            ) // vk.work_root_inverse
            mstore(
                mload(add(vk, 0xa0)),
                0x2ea411b5ad15d1bdb3574212e4a9f9a2a2bbd31e9b302159a97e7c4c37e4dc2e
            ) //vk.Q1
            mstore(
                add(mload(add(vk, 0xa0)), 0x20),
                0x17d8bc5f53bbba7aee1e6c60c053e5e26a4919454589b48b2f701b771373202d
            )
            mstore(
                mload(add(vk, 0xc0)),
                0x26ac642ba5238e8f43fd990d84ed3b8c31b8461ad49436aedbcc31c08865c912
            ) //vk.Q2
            mstore(
                add(mload(add(vk, 0xc0)), 0x20),
                0x0ae1bf5e822d02f8a37d3df47fe10f6ec9913e95369ea6a85ff2feec105681ff
            )
            mstore(
                mload(add(vk, 0xe0)),
                0x104344177a4923d30361834d1a6674b4d4b7cae5e743d71f6a45fbd53a26cad8
            ) //vk.Q3
            mstore(
                add(mload(add(vk, 0xe0)), 0x20),
                0x283a9f78ce9fad2c3b83bd3da0f13e85f7416370b33b394610ba5d1359170357
            )
            mstore(
                mload(add(vk, 0x100)),
                0x1f4ce25e7279d1688e172e5ca03e790e30e528eeab1d75a07045a5cbc39799ca
            ) //vk.Q4
            mstore(
                add(mload(add(vk, 0x100)), 0x20),
                0x103e65907eda0c262199feb8ce9c3392b5f437ccf98be7982a26523c7381efe0
            )
            mstore(
                mload(add(vk, 0x120)),
                0x2fcec038148d34d50c8ff7afd000b5f5867434ce6bfa147e53f68a80708cc453
            ) //vk.Q5
            mstore(
                add(mload(add(vk, 0x120)), 0x20),
                0x2fdc614ab6a260bbbd7c44fab5a96032c199b952f2f9b83c1d3d64f6bdd01f6e
            )
            mstore(
                mload(add(vk, 0x140)),
                0x273eb69df4386f3e7ac6952524d3f2e450b5c63b9889ffc9e7ad6d2434bbdb21
            ) //vk.QM
            mstore(
                add(mload(add(vk, 0x140)), 0x20),
                0x12e058df7fabacd651f674d5e6b0a4dbbe3cb78657cd298739855f55805541a8
            )
            mstore(
                mload(add(vk, 0x160)),
                0x0abfeec8db6538f883999af9b1a26b1f679d3d63d7cd14f4dd25d056235f107f
            ) //vk.QC
            mstore(
                add(mload(add(vk, 0x160)), 0x20),
                0x25a4bb7a0844607133a2144c925abbed6a887c720240bf6b89e4b39770a6af03
            )
            mstore(
                mload(add(vk, 0x180)),
                0x115b2348ab005c9490ff27beda38773eba9abace0c87a658337c4d96898b6ba6
            ) //vk.QARITH
            mstore(
                add(mload(add(vk, 0x180)), 0x20),
                0x029cd41d6f7c58392272cbbaf58c6e1317ec04125cf3f29e73d0be1efb584825
            )
            mstore(
                mload(add(vk, 0x1a0)),
                0x132e9abf85475c0b3957a040fd6655fec9e15ad847adad9a9d0d97db9fdf5b4d
            ) //vk.QECC
            mstore(
                add(mload(add(vk, 0x1a0)), 0x20),
                0x128eca5d8fefa2894cb93d4ef2b05fe8a8b3a9fb52c9fabe563539e0de6c4a54
            )
            mstore(
                mload(add(vk, 0x1c0)),
                0x28d8a42c830fd201ec4c1f0ae14267c2bd5d9425ecefc1c990f16ed4cd02978c
            ) //vk.QRANGE
            mstore(
                add(mload(add(vk, 0x1c0)), 0x20),
                0x183a78cd990fe656b8ba119790000a5abdc2973d53d3a5759f50a7ea211d6d70
            )
            mstore(
                mload(add(vk, 0x1e0)),
                0x1e0744e5b0a82f595892c353ee228e4dd4b660e1e9a8fdcb209bd48dff68675e
            ) //vk.QLOGIC
            mstore(
                add(mload(add(vk, 0x1e0)), 0x20),
                0x0526cc25b500ee6440dfca3b2d823a1636c094e0673d91b1fb730cf9d8c88b9f
            )
            mstore(
                mload(add(vk, 0x200)),
                0x2dda3670e6cebe6150475cb7158ffe8d02771cafc5c91e70905b036d0f2a8fa9
            ) //vk.SIGMA1
            mstore(
                add(mload(add(vk, 0x200)), 0x20),
                0x1ad19a7ed7b3f0a25f556e470df4d9f5e597cebce6e5d33bf14b9fa7522000e4
            )
            mstore(
                mload(add(vk, 0x220)),
                0x0701f6c8779d27900116ef063276154f515a7dd71082df1808bbc8fa3a06ecc5
            ) //vk.SIGMA2
            mstore(
                add(mload(add(vk, 0x220)), 0x20),
                0x0d8b672c6a8474e31b586558706217f8fb5b81edbc18196d31de3dbdb1e5721a
            )
            mstore(
                mload(add(vk, 0x240)),
                0x2c1730885dba1e1cba11969136c8fd1947df5d695fe51faf7dcbe10b74966ac3
            ) //vk.SIGMA3
            mstore(
                add(mload(add(vk, 0x240)), 0x20),
                0x02a0b05d504e72a0de05e8179c8acfc730a5a043739bed6e32e41e878ccec1f7
            )
            mstore(
                mload(add(vk, 0x260)),
                0x0009eb7b1a20161bf73eeecfba3121d00a7c8f1b1abf6aecbaa9f251f250b3ab
            ) //vk.SIGMA4
            mstore(
                add(mload(add(vk, 0x260)), 0x20),
                0x1356a39b7ffe3d20a3003d44b72fc2a8017d70f77b82e85ba659cc7812d61792
            )
            ...
            mstore(
                add(mload(add(vk, 0x2c0)), 0x40),
                0x04fc6369f7110fe3d25156c1bb9a72859cf2a04641f99ba4ee413c80da6a5fe4
            ) // vk.g2_x.Y.c1
            mstore(
                add(mload(add(vk, 0x2c0)), 0x60),
