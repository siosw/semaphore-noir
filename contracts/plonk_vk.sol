...
contract TurboVerifier {
    ...
    **/
    ...
    function get_verification_key() internal pure returns (Types.VerificationKey memory) {
        ...
        assembly {
            mstore(add(vk, 0x00), 4096) // vk.circuit_size
            mstore(add(vk, 0x20), 4) // vk.num_inputs
            mstore(add(vk, 0x40),0x0931d596de2fd10f01ddd073fd5a90a976f169c76f039bb91c4775720042d43a) // vk.work_root
            mstore(add(vk, 0x60),0x3061482dfa038d0fb5b4c0b226194047a2616509f531d4fa3acdb77496c10001) // vk.domain_inverse
            mstore(add(vk, 0x80),0x1af864d211b88d9ccf2e371c2ba088d9269d3fdea04e05acb6f70f8dc79e0e57) // vk.work_root_inverse
            mstore(mload(add(vk, 0xa0)), 0x06d9d631e140bf16e880bf48b20eb4cc527344c580a19c2e2dfd2415e0ab6a86)//vk.Q1
            mstore(add(mload(add(vk, 0xa0)), 0x20), 0x1b066e66e83d514ac3b64287fadd7820e35b901ed3567e1c038a889c6ba236ca)
            mstore(mload(add(vk, 0xc0)), 0x26e203777f500bf4d5ef3cd3451ff81864bff2e49ba640d549a899c513c62868)//vk.Q2
            mstore(add(mload(add(vk, 0xc0)), 0x20), 0x2c04affab436ced4168e7bf096211923a0dda1d53e2b12c17cdf2ce9e7022fa8)
            mstore(mload(add(vk, 0xe0)), 0x048f451130cc02abcad2fae10a9511acccff7c80cb5d2332abef793862944236)//vk.Q3
            mstore(add(mload(add(vk, 0xe0)), 0x20), 0x294e509beabc1dec0abb47b9b0fb601421312a580c9a03b4e8ca3b7ab41bc3cc)
            mstore(mload(add(vk, 0x100)), 0x29706583a3c034540daebe4db6a899dd03047f1d8cfd88e4e5bcc56f5c565df5)//vk.Q4
            mstore(add(mload(add(vk, 0x100)), 0x20), 0x224b3aea528d426e5bcce39c80648106ae77749452b300d794d7618c5e94558a)
            mstore(mload(add(vk, 0x120)), 0x02b9341746479178127cc8ca5f4c398754ee944184f9955517bf54822922df26)//vk.Q5
            mstore(add(mload(add(vk, 0x120)), 0x20), 0x07c962a293a2e4530a43129b22f40b60f937305afa560c535dd8cf3864197be4)
            mstore(mload(add(vk, 0x140)), 0x1c1fee42faac29e3f93d9b49d5373029244f2fa6de3903e82bf13f40b7432e80)//vk.QM
            mstore(add(mload(add(vk, 0x140)), 0x20), 0x0c0907fc1ec2b38c45907c676ed85abdf9350a1eaefde0116623b4f3b38774a5)
            mstore(mload(add(vk, 0x160)), 0x11f039a7e2887a0fcdd110e20a4efe055fe0bb34df4d6f6784a88e38a26a657f)//vk.QC
            mstore(add(mload(add(vk, 0x160)), 0x20), 0x2b4090642ee30c9445842bf9ddc14b5b0d32da5cba6ed48d00128b98ee81c3fc)
            mstore(mload(add(vk, 0x180)), 0x2e8ef79bd9dbafd36e2a6f7f602ff9f9626e4e8eb69b9fcb1d63ebcd30ccf05c)//vk.QARITH
            mstore(add(mload(add(vk, 0x180)), 0x20), 0x13ac38173868a0a20fbeda9bca94da9557762f676eeebe0dc8e2a8f8bfb2f6b4)
            mstore(mload(add(vk, 0x1a0)), 0x2be7d46a66593cd5fcb5bcb29018a426c19bbd29c8da4fc0ab29d3c4f3772caf)//vk.QECC
            mstore(add(mload(add(vk, 0x1a0)), 0x20), 0x0119f6e1578550e7e3ca0597cc83f2c6fe6dd5b92f94ae4ceb808985f6f7f4b7)
            mstore(mload(add(vk, 0x1c0)), 0x04dcc86ee90e4def5d40116998dff648a02ed424af68be729097f1e38fc0d7ce)//vk.QRANGE
            mstore(add(mload(add(vk, 0x1c0)), 0x20), 0x0bda2fdd9f1a5a6f5068e791b415fb86ec73eee98153954cdbf16a5efa954cc6)
            mstore(mload(add(vk, 0x1e0)), 0x1f99ab321383bab6bcd6066e1d4a7b95459d2747117405e196ccaebcba1baf91)//vk.QLOGIC
            mstore(add(mload(add(vk, 0x1e0)), 0x20), 0x0d7d83510f2b89a66cddb5443badfd9edc0e50d1edf99b7fa6fb114cd078a3b0)
            mstore(mload(add(vk, 0x200)), 0x0c08aed607ee5be9d6acbe76877ea14537f4c349d6bf30e45d9b0d3d5e3b8a0a)//vk.SIGMA1
            mstore(add(mload(add(vk, 0x200)), 0x20), 0x0d5b51e303594898d263953130e67e0a31f6b82cd766529913d46c5613b84288)
            mstore(mload(add(vk, 0x220)), 0x02702061908fe8b2f9934cf78de0816ce4eab22f5702089cc845173ccacecf81)//vk.SIGMA2
            mstore(add(mload(add(vk, 0x220)), 0x20), 0x0bf529c0e1543f062942c66a75b0e4a02da5173e058c4ed81958fd9f5623a8ad)
            mstore(mload(add(vk, 0x240)), 0x17254e665ae4ae3b969bc185d37e81e46e7196a8149c45292469a994baab5641)//vk.SIGMA3
            mstore(add(mload(add(vk, 0x240)), 0x20), 0x0ebe2f508db3cb9911eafbcb6a74a43fb69cd42a95fde37f22879f4fcc5b17d2)
            mstore(mload(add(vk, 0x260)), 0x28125373df3181e53a367c1c803b6873723bb3dfa74b72053ed1fa9fae93ea18)//vk.SIGMA4
            mstore(add(mload(add(vk, 0x260)), 0x20), 0x007b017587a8c6a88d6fd13edc37c942114a8b0a34c6b3e71e08307c959e9dbe)
